...
# Idea: (ART) Build a coffe table that has a glass-covered sand table.  A pump would inject water at one end, which would flow down hill.  This would naturally createa river-delta pattern of deposition and erosion.  It could be quite beautiful. Some variation in the flow would simulate flooding.  This could be accomplished pretty easily (say $2000) and would make a very educational gift.
